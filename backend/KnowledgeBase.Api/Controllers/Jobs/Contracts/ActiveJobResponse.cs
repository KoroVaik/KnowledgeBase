...
/// <summary>
/// One job still <c>Pending</c> or <c>Running</c>. <c>KindDescription</c> is a one-sentence,
/// human-readable explanation of what that kind of job does. <c>AssetFileName</c> is set only for a
