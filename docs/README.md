...
| [`observability.md`](observability.md) | diagnosing request storms, uploads, worker jobs or logging | log fields, correlation, bounded delivery, retention, collector setup and next iteration |
