...
([AGENTS.md](../../../AGENTS.md)), sequenced for a fix instead of new work. The
...
in practical terms, *why* it's currently doing that (see AGENTS.md's Explanation level for
...
cleanup or refactoring (AGENTS.md's "one iteration, one scope" applies even more here than
...
- Add one line to [`docs/archive.md`](../../../docs/archive.md): what was broken, what
  fixed it, and how it was verified (per AGENTS.md: "verified: X → Y, all green" is
