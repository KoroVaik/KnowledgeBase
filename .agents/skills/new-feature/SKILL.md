...
([AGENTS.md](../../../AGENTS.md)) end to end. Each step below is a rule already in force
...
daily, explain those parts plainly (see AGENTS.md's Explanation level) — skip explaining
